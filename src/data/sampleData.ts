...
export const initialProjectMasterData: ProjectMasterData = {
  ...
  projectNameEn: 'N/A',
  clientNameFa: 'شرکت ملی صنایع پتروشیمی',
  clientNameEn: 'National Petrochemical Company (NPC)',
  projectManagerFa: 'مهندسان مشاور ستیران',
  projectManagerEn: 'Scetiran Consulting Engineers',
  consultantNameFa: 'مهندسین مشاور تدبیر ساحل پارس',
  consultantNameEn: 'Tadbir Sahel Pars Consulting Engineers',
  contractorNameFa: 'شرکت نواندیشان فراساحل لیان',
  contractorNameEn: 'Noandishan Farasahel Lian',
...
export const initialDailyReportRecord: DailyReportRecord = {
  ...
  keyIssues: [
    ...
    {
      id: 'iss-3',
      issueFa: 'عدم تعیین تکلیف دستور کار و قیمت جدید عملیات اصلاح لودینگ آرم',
      issueEn: 'Lack of resolution on work order and new rate for loading arm modification works',
      sourceFile: 'Daily_Report_Workbook.xlsx',
      sourceSheet: 'Construction (2)',
      sourceRow: 16,
      severity: null,
    ...
    {
      id: 'iss-4',
      issueFa: 'تعیین تکلیف مخزن WO جهت انجام عملیات اجرایی',
